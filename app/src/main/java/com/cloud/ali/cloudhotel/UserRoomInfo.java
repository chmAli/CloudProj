...
public class  UserRoomInfo extends AppCompatActivity {
    ...
    public void BookRoom(View v){
        room.setBooked(true);
        room.setBooker(FirebaseAuth.getInstance().getCurrentUser().getEmail());

        room_ref.child(Integer.toString(room.getRoom_num())).setValue(room);

        startActivity(new Intent(this, ViewRoomsUser.class));
